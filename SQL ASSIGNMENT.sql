...
INSERT INTO Bands (id, name) VALUES (100, 'Your Favorite Band');
INSERT INTO Albums (id, name, release_year, band_id) VALUES (200, 'Your Favorite Album', 2020, 100);
...
SELECT album_id,max(length) from songs;

##12. Get the number of songs for each band
SELECT 
    b.name, COUNT(s.id) AS song_count
FROM
    Bands b
        LEFT JOIN
...
SELECT 
    *, release_year - release_year % 10 AS decade
FROM
    Albums;
